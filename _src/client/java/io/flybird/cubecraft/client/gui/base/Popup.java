...
public class Popup {
    ...
    public void render(){
        ...
        ClientRegistries.TEXTURE.getTexture2DContainer().unbind("/resource/cubecraft/texture/ui/controls/popup.png");
        ClientRegistries.SMOOTH_FONT_RENDERER.render(title,40,12,0xffffff,12, FontAlignment.LEFT);
        ClientRegistries.SMOOTH_FONT_RENDERER.render(subTitle,40,28,0xffffff,8, FontAlignment.LEFT);
    }
