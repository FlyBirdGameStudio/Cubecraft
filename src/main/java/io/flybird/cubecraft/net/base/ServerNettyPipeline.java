...
import io.flybird.cubecraft.net.event.ChannelInitializeEvent;
 ...
 */
public class ServerNettyPipeline extends NettyPipeline {
                ...
                bootstrap.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class).option(ChannelOption.SO_BACKLOG, 128).childOption(ChannelOption.SO_KEEPALIVE, true)//keep channel alive :D
                        .childHandler(new ChannelInitializer<SocketChannel>() {
                            ...
                            protected void initChannel(@NotNull SocketChannel ch) {
                                ...
                                //给pipeline管道设置处理器
                                ch.pipeline().addLast(handler).addLast(new IdleStateHandler(10, 0, 0, TimeUnit.SECONDS));;
