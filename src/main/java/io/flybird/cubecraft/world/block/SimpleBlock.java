...
public class SimpleBlock extends Block{
    ...
    public final int resistance,density,hardness,opacity;
    public final boolean isSolid;
    private final String id;
    private final String[] tags;
    private final int light;

    public SimpleBlock(EnumFacing[] enumFacings, AABB[] collisionBoxSizes, AABB[] selectionBoxSizes, int resistance, int density, int hardness, int opacity, boolean isSolid, String id, String[] tags, int light) {
