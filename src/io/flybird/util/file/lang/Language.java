package io.flybird.util.file.lang;
...
public class Language {
    ...
    public void attachTranslationFile(String s){
        this.map.putAll(getLangFromStream(s));
    }
    ...
    public static HashMap<String,String> getLangFromStream(String s){
