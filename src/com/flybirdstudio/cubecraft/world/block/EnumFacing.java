...
public enum EnumFacing {
    ...
    static {
        ...
        faceMapping[3] = new int[]{4, 5, 1, 0, 2, 3};//back
        faceMapping[4] = new int[]{2, 3, 4, 5, 1, 0};//left
        faceMapping[5] = new int[]{2, 3, 4, 5, 0, 1};//right
    }
    ...
    public Vector3d clipVec(Vector3d vec) {
        ...
        return switch (this) {
            ...
            case North -> new Vector3d(MathHelper.reflect(vec.y,0.5),vec.x,vec.z);
            case South -> new Vector3d(vec.y,MathHelper.reflect(vec.x,0.5),vec.z);
