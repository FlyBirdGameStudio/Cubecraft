...
import com.flybirdstudio.cubecraft.world.entity.particle.Particle;
import com.flybirdstudio.cubecraft.world.entity.particle.ParticleEngine;
import com.flybirdstudio.cubecraft.world._Level;
...
public class Tile {
    ...
    public void render(VertexArrayBuilder vertexBuilder, _Level world, int layer, long x, long y, long z, long ax, long ay, long az) {
        byte c1 = -1;
        byte c2 = -52;
        byte c3 = -103;
    ...
    public void renderBackFace(VertexArrayBuilder vertexBuilder, long x, long y, long z, int face) {
        int tex = this.getTexture(face);
        int xt = tex % 16 * 16;
        int yt = tex / 16 * 16;
        float u0 = (float)xt / 256.0f;
