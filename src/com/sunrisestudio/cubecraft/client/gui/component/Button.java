...
public class Button extends Component {
    ...
    private void render(int x, int y, int w, int h, int layer) {
        ...
        Registry.getTextureManager().bind2dTexture("/resource/textures/gui/controls/button.png");
    ...
    static {
        Registry.getTextureManager().create2DTexture("/resource/textures/gui/controls/button.png", false, false);
    }
}
