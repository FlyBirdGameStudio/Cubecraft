package com.sunrisestudio.cubecraft.gui;
...
public class FontRenderer {
    ...
    public static void renderShadow(String s, int x, int y, int color, int size, Alignment alignment) {
        render(s, (int) (x + 0.125 * size), (int) (y + 0.125 * size), (int) MathHelper.step(color-0xbbbbbb,0xFFFFFF,0), size, alignment);
