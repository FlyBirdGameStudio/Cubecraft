...
public class OGGStream {
    ...
    public OGGStream(InputStream in) throws IOException {
        this.input = in;
        this.buffer.limit(0);
    ...
    private void convertStereo(FloatBuffer p_83761_, FloatBuffer p_83762_, OGGStream.OutputConcat p_83763_) {
    ...
    public ByteBuffer read(int p_83754_) throws IOException {
        OGGStream.OutputConcat oggaudiostream$outputconcat = new OGGStream.OutputConcat(p_83754_ + 8192);
    ...
    static class OutputConcat {
        ...
        public void put(float p_83776_) {
            ...
            int i = (int) MathHelper.clamp((int) (p_83776_ * 32767.5F - 0.5F), -32768, 32767);
