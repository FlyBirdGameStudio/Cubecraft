...
public class ProjectionMatrixFrustum extends ICuller{
    ...
    public ProjectionMatrixFrustum(Camera camera) {
        super(camera);
    }
    ...
    public boolean aabbVisible(AABB aabb) {
        //return this.frustumIntersection.intersectAab((float) aabb.x0, (float) aabb.y0, (float) aabb.z0, (float) aabb.x1, (float) aabb.y1, (float) aabb.z1)==FrustumIntersection.INTERSECT
        //|this.frustumIntersection.intersectAab((float) aabb.x0, (float) aabb.y0, (float) aabb.z0, (float) aabb.x1, (float) aabb.y1, (float) aabb.z1)==FrustumIntersection.INSIDE;
