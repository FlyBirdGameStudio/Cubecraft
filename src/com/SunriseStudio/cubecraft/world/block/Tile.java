...
import com.SunriseStudio.cubecraft.world.particle.Particle;
...
public class Tile {
    ...
    public void render(IVertexArrayBuilder vertexBuilder, Level world, int layer, long x, long y, long z, long ax, long ay, long az) {
        byte c1 = -1;
        byte c2 = -52;
        byte c3 = -103;
    ...
    protected boolean shouldRenderFace(Level world, long x, long y, long z, int layer, int face) {
