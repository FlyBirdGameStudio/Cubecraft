package io.flybird.cubecraft.client.gui.font;
...
public class SmoothedFontRenderer implements IFontRenderer{
    ...
    public void render(String string, int x, int y, int color, int size, FontAlignment alignment){
